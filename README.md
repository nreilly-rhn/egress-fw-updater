...
```
cd existing_repo
git remote add origin https://gitlab.cee.redhat.com/nreilly/egress-fw-updater.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cee.redhat.com/nreilly/egress-fw-updater/-/settings/integrations)
